...
GENERATED="${GOPATH}/src/gitlab.com/distributed_lab/acs/unverified-svc/resources"
OPENAPI_DIR="${GOPATH}/src/gitlab.com/distributed_lab/acs/unverified-svc/docs/web_deploy"
